...
class Mutations {
    constructor() {
        this.CREATE_USER = `mutation create_user($email: String!, $first_name: String!, $last_name: String!,$hash_password: String!, $role_id: Int!, $otp: Int = 10) {
    insert_users_one(object: {email: $email, first_name: $first_name, last_name: $last_name, hash_password: $hash_password, role_id: $role_id, otp: $otp}) {
      ...
      verified
        ...
        this.UPDATE_VERIFIED = `mutation update_verified($user_id: uuid!, $verified: Boolean = true) {
    update_users(where: {id: {_eq: $user_id}}, _set: {verified: $verified}) {
      returning {
        ...
        this.UPDATE_OTP = `mutation update_otp($user_id: uuid!, $otp: Int!) {
        ...
        this.RESET_PASSWORD = `mutation reset_password($_eq: String!, $hash_password: String!) {
