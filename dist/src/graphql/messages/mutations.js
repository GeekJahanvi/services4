...
class Mutations {
    constructor() {
        this.ADD_MESSAGES = `mutation add_messages($chat_room_id: uuid!, $user_id: uuid!, $content: String!, $created_at: timestamptz = "now()", $file_type: String!, $content_public_id: String) {
        ...
        this.DELETE_MESSAGES = `mutation delete_messages($message_id: uuid!) {
