...
class Mutations {
    constructor() {
        this.ADD_APPOINTMENT_FOR_LOVED_ONES = `mutation add_appointment_for_loved_one($member_id: uuid!, $doctor_id: uuid!, $appointment_date: date!, $appointment_for: String!, $details: String!, $duration: String!, $relationship: String!, $relatives_dob: date!, $relatives_full_name: String!, $time: time!, $agenda: String!, $timeslot_id: uuid!) {
        ...
        this.ADD_APPOINTMENT_FOR_MYSELF = `mutation add_appointment_for_myself($member_id: uuid!, $doctor_id: uuid!, $appointment_date: date!, $appointment_for: String!, $details: String!, $duration: String!, $time: time!, $agenda: String!, $timeslot_id: uuid!) {
