...
class Mutations {
    constructor() {
        this.ADD_ACCOUNT_DETAILS = `mutation add_account_details($doctor_id: uuid!, $account_type_id: uuid!, $account_number: numeric!, $account_holder: String!, $IFSC_code: String!, $bank_name: String!) {
